...
namespace Zoologicos_libreria.implementaciones
{
    public class AreasNegocio : IAreasNegocio
    {
        ...
        public List<Areas> Listar()
        {
            ...
            return this.iConexion.Areas!.ToList();
        }
        ...
        public Areas Guardar(Areas entidad)
        {
            ...
            this.iConexion!.Areas!.Add(entidad);
        ...
        public Areas Modificar(Areas entidad)
        {
            ...
            var entry = this.iConexion!.Entry<Areas>(entidad);
...

        {
            ...
            var entidad = this.iConexion.Areas!.FirstOrDefault(x => x.Id == id);

            if (entidad == null)
            {
                throw new Exception("NoExisteRegistro");
            }
            this.iConexion.Areas!.Remove(entidad);
            this.iConexion.SaveChanges();
            return true;
