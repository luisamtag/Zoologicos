...
namespace Zoologicos_libreria_Presentacion.implementaciones
{
    public class EntradasNegocio : IEntradasNegocio
    {
        ...
        private const string BaseUrl = "http://localhost:5202/Entradas/";
        public List<Entradas> Listar()
        {
            ...
            return JsonConvert.DeserializeObject<List<Entradas>>(respuesta["Valor"].ToString()!)!;
        }
        ...
        public Entradas Guardar(Entradas entidad)
        {
            ...
            if (string.IsNullOrEmpty(entidad.TipoEntrada))
            ...
            return JsonConvert.DeserializeObject<Entradas>(respuesta["Valor"].ToString()!)!;
        }
        ...
        //public Entradas Borrar (Entradas entidad)
        {
