...
namespace Zoologicos_libreria_Presentacion.implementaciones
{
    public class HabitatsNegocio : IHabitatsNegocio
    {
        ...
        private const string BaseUrl = "http://localhost:5202/Habitats/";
        public List<Habitats> Listar()
        {
            ...
            return JsonConvert.DeserializeObject<List<Habitats>>(respuesta["Valor"].ToString()!)!;
        }
        ...
        public Habitats Guardar(Habitats entidad)
        {
            ...
            return JsonConvert.DeserializeObject<Habitats>(respuesta["Valor"].ToString()!)!;
        }
        ...
        //public Habitats Borrar (Habitats entidad)
        {
