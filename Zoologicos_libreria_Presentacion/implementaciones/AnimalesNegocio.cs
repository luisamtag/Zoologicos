...
namespace Zoologicos_libreria_Presentacion.implementaciones
{
    public class AnimalesNegocio : IAnimalesNegocio
    {
        ...
        private const string BaseUrl = "http://localhost:5193/Animales/";
        public List<Animales> Listar()
        {
            ...
            return JsonConvert.DeserializeObject<List<Animales>>(respuesta["Valor"].ToString()!)!;
        }
        ...
        public Animales Guardar(Animales entidad)
        {
            ...
            return JsonConvert.DeserializeObject<Animales>(respuesta["Valor"].ToString()!)!;
        }
