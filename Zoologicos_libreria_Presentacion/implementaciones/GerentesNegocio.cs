...
namespace Zoologicos_libreria_Presentacion.implementaciones
{
    public class GerentesNegocio : IGerentesNegocio
    {
        ...
        private const string BaseUrl = "http://localhost:5202/Gerentes/";
        public List<Gerentes> Listar()
        {
            ...
            return JsonConvert.DeserializeObject<List<Gerentes>>(respuesta["Valor"].ToString()!)!;
        }
        ...
        public Gerentes Guardar(Gerentes entidad)
        {
            ...
            return JsonConvert.DeserializeObject<Gerentes>(respuesta["Valor"].ToString()!)!;
        }
        ...
        //public Gerentes Borrar (Gerentes entidad)
        {
