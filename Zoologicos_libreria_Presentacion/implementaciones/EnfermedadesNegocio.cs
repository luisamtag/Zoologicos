...
namespace Zoologicos_libreria_Presentacion.implementaciones
{
    public class EnfermedadesNegocio : IEnfermedadesNegocio
    {
        ...
        private const string BaseUrl = "http://localhost:5144/Enfermedades/";
        public List<Enfermedades> Listar()
        {
            ...
            return JsonConvert.DeserializeObject<List<Enfermedades>>(respuesta["Valor"].ToString()!)!;
        }
        ...
        public Enfermedades Guardar(Enfermedades entidad)
        {
            ...
            return JsonConvert.DeserializeObject<Enfermedades>(respuesta["Valor"].ToString()!)!;
        }
        ...
        //public Enfermedades Borrar (Enfermedades entidad)
        {
