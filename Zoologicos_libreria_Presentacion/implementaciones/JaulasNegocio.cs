...
namespace Zoologicos_libreria_Presentacion.implementaciones
{
    public class JaulasNegocio : IJaulasNegocio
    {
        ...
        private const string BaseUrl = "http://localhost:5202/Jaulas/";
        public List<Jaulas> Listar()
        {
            ...
            return JsonConvert.DeserializeObject<List<Jaulas>>(respuesta["Valor"].ToString()!)!;
        }
        ...
        public Jaulas Guardar(Jaulas entidad)
        {
            ...
            if (entidad.FechaCompra == DateTime.MinValue)
                throw new Exception("Falta informacion: La fecha de compra especificada no es válida.");
            ...
            return JsonConvert.DeserializeObject<Jaulas>(respuesta["Valor"].ToString()!)!;
        }
        ...
        //public Jaulas Borrar (Jaulas entidad)
        {
