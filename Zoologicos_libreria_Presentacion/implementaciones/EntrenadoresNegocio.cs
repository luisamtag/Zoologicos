...
namespace Zoologicos_libreria_Presentacion.implementaciones
{
    public class EntrenadoresNegocio : IEntrenadoresNegocio
    {
        ...
        private const string BaseUrl = "http://localhost:5202/Entrenadores/";
        public List<Entrenadores> Listar()
        {
            ...
            return JsonConvert.DeserializeObject<List<Entrenadores>>(respuesta["Valor"].ToString()!)!;
        }
        ...
        public Entrenadores Guardar(Entrenadores entidad)
        {
            ...
            return JsonConvert.DeserializeObject<Entrenadores>(respuesta["Valor"].ToString()!)!;
        }
