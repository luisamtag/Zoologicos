...
namespace Zoologicos_libreria_Presentacion.implementaciones
{
    public class VisitantesNegocio : IVisitantesNegocio
    {
        ...
        private const string BaseUrl = "http://localhost:5202/Visitantes/";
        public List<Visitantes> Listar()
        {
            ...
            return JsonConvert.DeserializeObject<List<Visitantes>>(respuesta["Valor"].ToString()!)!;
        }
        ...
        public Visitantes Guardar(Visitantes entidad)
        {
            ...
            if (string.IsNullOrEmpty(entidad.TipoDocumento) || string.IsNullOrEmpty(entidad.NumeroDocumento))
                throw new Exception("Falta informacion: El tipo y número de documento son obligatorios.");
            ...
            return JsonConvert.DeserializeObject<Visitantes>(respuesta["Valor"].ToString()!)!;
        }
        ...
        //public Visitantes Borrar (Visitantes entidad)
        {
