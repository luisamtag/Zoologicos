...
namespace Zoologicos_libreria_Presentacion.implementaciones
{
    public class ZoologicosNegocio : IZoologicosNegocio
    {
        ...
        public List<Zoologicos> Listar()
        {
            ...
            return JsonConvert.DeserializeObject<List<Zoologicos>>(respuesta["Valor"].ToString()!)!;
        }
        ...
        public Zoologicos Guardar(Zoologicos entidad)
        {
            ...
            if (string.IsNullOrEmpty(entidad.Nombre))
                throw new Exception("Falta informacion: El nombre de la sede es obligatorio.");

            if (string.IsNullOrEmpty(entidad.Ubicacion))
                throw new Exception("Falta informacion: La ubicación geográfica es obligatoria.");
            ...
            return JsonConvert.DeserializeObject<Zoologicos>(respuesta["Valor"].ToString()!)!;
        }
