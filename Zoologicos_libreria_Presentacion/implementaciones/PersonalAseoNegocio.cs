...
namespace Zoologicos_libreria_Presentacion.implementaciones
{
    public class PersonalAseoNegocio : IPersonalAseoNegocio
    {
        ...
        private const string BaseUrl = "http://localhost:5144/PersonalAseo/";
        public List<PersonalAseo> Listar()
        {
            ...
            return JsonConvert.DeserializeObject<List<PersonalAseo>>(respuesta["Valor"].ToString()!)!;
        }
        ...
        public PersonalAseo Guardar(PersonalAseo entidad)
        {
            ...
            if (string.IsNullOrEmpty(entidad.Turno))
                throw new Exception("Falta informacion: Debe seleccionar el turno asignado.");
            ...
            return JsonConvert.DeserializeObject<PersonalAseo>(respuesta["Valor"].ToString()!)!;
        }
        ...
        //public PersonalAseo Borrar (PersonalAseo entidad)
        {
